...
class KaamNotificationTypes {
  ...
  static const supported = {
    ...
    'candidate_verification_rejected':
        KaamNotificationType.candidateVerificationRejected,
    'candidate_reverification_required':
        KaamNotificationType.candidateReverificationRequired,
  };
}
  ...
  static String routeFor({
    ...
    return switch ((role, type)) {
      ...
      (KaamRole.candidate, 'candidate_document_resubmission_requested') =>
        AppRoutes.documentsUpload,
      (KaamRole.candidate, 'candidate_verification_approved') =>
        AppRoutes.profile,
      (KaamRole.candidate, 'candidate_verification_rejected') =>
        AppRoutes.profile,
      (KaamRole.candidate, 'candidate_reverification_required') =>
        AppRoutes.profile,

      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Image.asset(AppAssets.logo, width: 240, fit: BoxFit.contain),
              const SizedBox(height: 12),
              const Text(
                'Privacy-first hiring for UAE and GCC teams.',
        ...
        const AppCard(
          child: Text(
            'Employers can create a company profile, search visible candidates, and send interest requests.',
            style: AppTextStyles.body,
          ),
        ),
        const SizedBox(height: 20),

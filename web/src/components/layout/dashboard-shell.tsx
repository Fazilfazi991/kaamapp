...
export function DashboardShell({
  ...
  return (
    <div className="app-height bg-[#fffafc] lg:flex">
      <DashboardSidebar items={items} title={title} account={account} />
      <main className="dashboard-main min-w-0 flex-1 px-4 py-5 pb-[calc(7rem+env(safe-area-inset-bottom))] sm:px-6 lg:px-7 lg:py-6">

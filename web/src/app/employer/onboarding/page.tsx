...
export default async function EmployerOnboardingPage() {
  ...
  return (
    <div className="grid gap-6">
      <PageTitle title="Employer onboarding" description="Complete your company profile to start using employer tools." />
      <section className="rounded-lg border border-[#eadde3] bg-white p-5 shadow-sm">
        ...
        <div className="mt-5 grid gap-2 text-sm text-[#3b3340]">
          ...
          <p>Verification: {company?.is_verified ? "Verified" : "Not verified (optional)"}</p>
        </div>
